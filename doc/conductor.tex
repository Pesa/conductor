...
\title{\textsl{Conductor}: an automatic audio routing system\\based on the RSSI of a passive Bluetooth device}
...
Kate is a modern housewife who likes listening to music while doing the housework. Her house is quite big though, and with just one hi-fi in the living room, she cannot hear the music loud enough when she is working in some other rooms. This issue is a major nuisance to her listening experience.

%Installing a speaker in each room is not a nice solution, because she does not want to waste huge amounts of electricity to power on the speakers in rooms where she is not working at the moment.
%She thought about installing a speaker in each room, but soon she realized that all those speakers would have required quite a bit of power to be simultaneously turned on. That seemed a waste because she is not ubiquitous!
\textsl{Conductor} is exactly what she is looking for: she just needs to install a special kind of speaker in each room and, as long as she keeps her Bluetooth-equipped mobile phone in her pocket, she can freely move from room to room and the music smoothly follows her without interruptions.
